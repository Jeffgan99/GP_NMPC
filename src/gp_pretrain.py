...
filename = 'set/{}gpiz08.pickle'.format(state_names[VARIDX])


def load_data(MODE, TYPE1, TYPE2, VARIDX, xscaler=None, yscaler=None):
    data_dyn = np.load('/home/elitedog/Dynamic_bic_mpc/gpnew/set/DYN-{}-{}.npz'.format(MODE, TYPE1))
    data_bas = np.load('/home/elitedog/Dynamic_bic_mpc/gpnew/set/DYN-{}-{}.npz'.format(MODE, TYPE2))
...
x_train, y_train, xscaler, yscaler = load_data('simu', 'cr1.23', 'baseline', VARIDX)
